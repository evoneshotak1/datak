...
do
local SUDO = 185532812 --put your id here(BOT OWNER ID)
...
local function res_user_callback(extra, success, result) -- /info <username> function
  ...
  text = text..'@datak_TG_1'
  send_msg(extra.receiver, text, ok_cb,  true)
  else
	send_msg(extra.receiver, extra.user..' نام کاربری مورد نظر یافت نشد.', ok_cb, true)
  end
end
...
local function run(msg, matches)
 if matches[1]:lower() == 'مقام جدید' then
